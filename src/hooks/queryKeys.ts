...
export const queryKeys = {
  ...
  attackTechniques: (days: number | null = null) => ["attack-techniques", days] as const,
  ...
  iocSourceCoverage: ["ioc-source-coverage"] as const,
  ...
  aiSummaryProvenance: ["ai-summary-provenance"] as const,
  emergingThreatsRanking: ["emerging-threats-ranking"] as const,
